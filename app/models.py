...
class Applicant(models.Model):
    ...
    applicant_name = models.CharField(default=None, max_length=15, null=True)
    phone_number   = models.IntegerField(default=None, null=True)
    d_o_b          = models.DateField(default=None, null=True)
    propel_mode    = models.CharField( default=None, max_length=15, null=True)
    job_state      = models.BooleanField(default=True, null=True)
    fcc_link       = models.CharField(default=None, max_length=150, null=True)
    interest       = models.CharField(default=None, max_length=250, null=True)
    fcc_eligible   = models.BooleanField(default=False, null=True)
